        ...
        <div className="mb-12 grid grid-cols-2 gap-8 md:grid-cols-4 lg:grid-cols-5">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-medium text-slate-500">
              <li>
                <Link href="#features" className="transition-colors hover:text-[#6C5DD3]">
                  Features
                </Link>
              </li>
              <li>
                <Link href="/ezcharts/examples" className="transition-colors hover:text-[#6C5DD3]">
                  Templates
                </Link>
              </li>
              <li>
                <Link href="#pricing" className="transition-colors hover:text-[#6C5DD3]">
                  Pricing
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-medium text-slate-500">
              <li>
                <Link href="#" className="transition-colors hover:text-[#6C5DD3]">
                  About Us
                </Link>
              </li>
              <li>
                <Link href="/contact" className="transition-colors hover:text-[#6C5DD3]">
                  Contact
                </Link>
              </li>
            </ul>
